package com.sublimetech.supervisor.presentation.ui.profesional.woman.homeScreen
...
@HiltViewModel
class WomanHomeViewModel @Inject constructor(
    private val userUseCase: UserUseCases,
    private val projectUseCases: ProjectUseCases
) : ViewModel() {

    private val _uiState = MutableStateFlow(WomanHomeUiState())
